...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'account', loadChildren: () => import('./pages/account/account.module').then(m => m.AccountModule), canActivate: [AuthGuard], data: {roles: []} }, 
            { path: 'submit-property', loadChildren: () => import('./pages/submit-property/submit-property.module').then(m => m.SubmitPropertyModule), canActivate: [AuthGuard], data: {roles: ['Admin', 'Realtor', 'Property Manager', 'Company Admin']} }   
        ]
    },
