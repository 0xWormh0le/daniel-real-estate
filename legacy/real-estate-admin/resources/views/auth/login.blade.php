...
<head>
    ...
    <title>Housekey Admin Page</title>
                                                ...
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        ...
                                                        <label for="email">Email</label>
                                                            ...
                                                            <span class="invalid-email" style="display:none;" role="alert">
                                                                <strong>{{ _('These credentials do not match our records.') }}</strong>
                                                            </span>
                                                    </fieldset>
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-right btn-block">{{ __('Login') }}</button>
                                                </form>
                                            </div>
                                        </div>
