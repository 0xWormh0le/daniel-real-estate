...
<div class="container">
	<div class="mdl-grid full-grid">
		<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card bg-color-gray">
			<div class="mdl-card card-wide" style="width:100%;border-radius: 10px;" itemscope itemtype="https://schema.org/Person">
				<div class="mdl-user-avatar">
					<img src="{{ $userGravImage }}" alt="{{ $user->id }}" class="user-avatar">
				...
				<div class="mdl-card__supporting-text">
					<div class="mdl-grid full-grid padding-0">
						...
						@if ($user->profile->bio)
							<div class="mdl-cell mdl-cell mdl-cell--12-col-phone mdl-cell--12-col-tablet mdl-cell--6-col-desktop margin-top-0 margin-top-2-desktop" style="background-color: #edf2f7; border-radius: 10px;">
								<li class="mdl-list__item">
									<span class="mdl-list__item-primary-content" style="padding: 20px;">
										{{-- <i class="material-icons mdl-list__item-icon">comment</i> --}}
										<span class="mdl-typography--font-light" style="line-height: 30px;">
											{{ $user->profile->bio }}
						...
						<div class="mdl-cell mdl-cell--12-col">
							@if ($user->profile)
								@if (Auth::user()->id == $user->id)
									<a href="/profile/{{ Auth::user()->name }}/edit" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-shadow--3dp mdl-button--raised mdl-button--primary mdl-color-text--white" style="background: #1764dd;">
