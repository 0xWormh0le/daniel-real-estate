							...
							<form>
													...
													<div class="demo_1 col-md-12" style="padding: 0; clear: both;">
														...
														<div class = "row plan">
															<div class="form-group">
																...
																<div class ="col-md-12">
																	<img class="img-upload-preview" id="blah_0" src="/assets/img/default.jpg" alt="preview" name = "plan[0][image]" width = "100">
																</div>
																<div class ="col-md-12">
								...
								<div class="wizard-action">
									...
									<div class="pull-right">
										...
										<input type="button" class="btn btn-finish btn-danger" name="finish" value="Finish" onClick = "create_property()" style="display: none;">
									</div>
